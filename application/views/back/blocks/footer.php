...
<!-- Central Modal Small -->
  ...
  <?php endif; ?>
    ...
    <script type="text/javascript">
      ...
      <?php if($this->uri->segment(3) != '' && $this->uri->segment(2) == 'slider'): ?>
      // document.querySelector('#submit').addEventListener('click', function(event){
      //   if(document.querySelector('#slider_title').value.length > 12){
      //     event.preventDefault();
      //     var title = document.querySelector('#slider_title').value;
      //     if(!document.querySelector('#danger')){
      //       document.querySelector('#title_div').innerHTML += '<label class="text-danger" id="danger">To pole musi mieć max. 12 znaków!</label>';
      //     }
