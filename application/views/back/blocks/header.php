<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php $main_page = ['slider', 'treatments_1', 'bloomea', 'treatments_2', 'attributes_descriptions', 'attributes', 'pricelist', 'facebook', 'facebook_descriptions']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $main_page)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/slider" class="nav-link <?php if($this->uri->segment(2) == 'slider'){echo 'active';} ?>">Slider</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/bloomea" class="nav-link <?php if($this->uri->segment(2) == 'bloomea'){echo 'active';} ?>">Bloomea</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/attributes_descriptions" class="nav-link <?php if($this->uri->segment(2) == 'attributes_descriptions'){echo 'active';} ?>">Nagłówki atutów</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/attributes" class="nav-link <?php if($this->uri->segment(2) == 'attributes'){echo 'active';} ?>">Atuty</a></li>
          
          
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/facebook" class="nav-link <?php if($this->uri->segment(2) == 'facebook'){echo 'active';} ?>">Facebook - posty</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/facebook_descriptions" class="nav-link <?php if($this->uri->segment(2) == 'facebook_descriptions'){echo 'active';} ?>">Facebook - opisy</a></li>
        </ul>

        <a href="" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), ['owner', 'about'])){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-folder-open tx-20"></i>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/about" class="nav-link <?php if($this->uri->segment(2) == 'about'){echo 'active';} ?>">O nas</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/owner" class="nav-link <?php if($this->uri->segment(2) == 'owner'){echo 'active';} ?>">Właściciel</a></li>
        </ul>

        <?php $offers = ['offers', 'offers_pricelist']; ?>
        <a href="" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $offers)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/offers" class="nav-link <?php if($this->uri->segment(2) == 'slider'){echo 'active';} ?>">Oferty</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/offers_pricelist" class="nav-link <?php if($this->uri->segment(2) == 'offers_pricelist'){echo 'active';} ?>">Sekcja cennik</a></li>
          
        </ul>

        <a href="<?php echo base_url(); ?>panel/gallery_page" class="br-menu-link
        <?php if($this->uri->segment(2) == 'gallery_page'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <?php if($this->uri->segment(2) == 'news'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <?php $pricelist = ['pricelist', 'pricelist_descriptions']; ?>
        <a href="" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $pricelist)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fas fa-list tx-20"></i>
            <span class="menu-item-label">Cennik</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/pricelist" class="nav-link <?php if($this->uri->segment(2) == 'pricelist'){echo 'active';} ?>">Cennik</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/pricelist_descriptions" class="nav-link <?php if($this->uri->segment(2) == 'pricelist_descriptions'){echo 'active';} ?>">Opisy Cennika</a></li>
          
        </ul>
        

        <?php $contact_page = ['contact_descriptions', 'contact_icons', 'contact']; ?>
        <a href="#" class="br-menu-link
        <?php if(in_array($this->uri->segment(2), $contact_page)){echo 'show-sub';} ?>">
          <div class="br-menu-item">
            <i class="menu-item-icon fas fa-phone tx-20"></i>
            <span class="menu-item-label">Kontakt</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div>
        </a>
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/contact" class="nav-link <?php if($this->uri->segment(2) == 'contact'){echo 'active';} ?>">Opisy z zakładce kontakt</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/contact_descriptions" class="nav-link <?php if($this->uri->segment(2) == 'contact_descriptions'){echo 'active';} ?>">Opisy</a></li>
          <li class="nav-item"><a href="<?php echo base_url(); ?>panel/contact_icons" class="nav-link <?php if($this->uri->segment(2) == 'contact_icons'){echo 'active';} ?>">Ikony</a></li>
        </ul>
        ...
        <?php if($this->uri->segment(2) == 'example' || $this->uri->segment(4) == 'example'){echo 'active';} ?>">
          <div class="br-menu-item">
        ...
        <a href="#" class="br-menu-link
        <?php if($this->uri->segment(2) == 'example_dropdown' || $this->uri->segment(4) == 'example_dropdown'){echo 'active';} ?>">
          <div class="br-menu-item">
