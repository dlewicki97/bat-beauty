            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?php echo substr($value->link, 0, 40); if(strlen($value->link) > 40) echo '...' ?></td>
                  <td class="text-right">
                      ...
                      onclick="return confirm('Czy na pewno chcesz usunąć <?php echo $value->link; ?>? #<?php echo $value->id; ?>')" >
