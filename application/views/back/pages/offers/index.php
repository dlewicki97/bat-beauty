    ...
    <div class="br-mainpanel">
          ...
          <table id="datatable1" class="table display responsive nowrap">
            <thead>
              <tr>
                ...
                <th class="wd-5p align-top">Strona<br>główna<br>pierwsze<br>oferty</th>
                <th class="wd-5p align-top">Strona<br>główna<br>drugie<br>oferty</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle">
                  <label class="ckbox">
                    <input type="checkbox" onchange="checkbox('offers', 'offers_1', <?= $value->home_page ? 1 : 0 ?>, <?= $value->id ?>);" <?php if($value->offers_1) echo 'checked'; ?>>
                    <span></span>
                  </label>
                </td>
                <td class="align-middle">
                  <label class="ckbox">
                    <input type="checkbox" onchange="checkbox('offers', 'offers_2', <?= $value->home_page ? 1 : 0 ?>, <?= $value->id ?>);" <?php if($value->offers_2) echo 'checked'; ?>>
                    <span></span>
                  </label>
                </td>
      ...
      function checkbox(table, field, value, id) {
        $.ajax({  
             type: "post", 
             url:"<?= base() ?>panel/offers/checkbox", 
