        ...
        <form class="form-layout form-layout-2" action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . $this->uri->segment(2); ?>/<?php echo @$value->id; ?>" method="post"  enctype="multipart/form-data">
            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-b-0-force bd-l-0-force bd-r-0-force">
                    ...
                    <div class="row">
                        <div class="col-md pr-0">
                            <div class="form-group bd-b-0-force bd-r-0-force">
                                ...
                                <textarea class="summernote" type="text" name="description" value=""><?php echo @$value->description; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div id="photoViewer_2" class="form-group  bd-t-0-force">
                            <label class="form-control-label">Napis na zdjęciu w tle:</label>
                            <input class="form-control" type="text" name="bg_title" value="<?php echo @$value->bg_title; ?>">
                        </div>
                    </div>
